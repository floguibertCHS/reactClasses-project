...
class Factory {
  constructor(){
    ...
    this.customerBuild = function (color, options) {
      console.log('Building one '+ color +' '+ this.trim+' '+this.model+' with the following options: '+ options.option);
    };
  }
}
...
class Car extends Factory {
  constructor (carDetails){
    ...
    this.enginetype = carDetails.enginetype;
    this.transmission = carDetails.transmission;
    this.trim = carDetails.trim;
    this.wheelstrim = carDetails.wheelstrim;
    this.audio = carDetails.audio;
    this.seatstrim = carDetails.seatstrim;
    this.moonroof = carDetails.moonroof;
